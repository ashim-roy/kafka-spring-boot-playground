 ...
 */
package com.ashimCS.learnKafka.event;
...
public class userCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5486006453152802196L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"userCreatedEvent\",\"namespace\":\"com.ashimCS.learnKafka.event\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"}]}");
   ...
   */
  public static com.ashimCS.learnKafka.event.userCreatedEvent.Builder newBuilder() {
    return new com.ashimCS.learnKafka.event.userCreatedEvent.Builder();
  }
   ...
   * @return A new userCreatedEvent RecordBuilder
   */
  public static com.ashimCS.learnKafka.event.userCreatedEvent.Builder newBuilder(com.ashimCS.learnKafka.event.userCreatedEvent.Builder other) {
    return new com.ashimCS.learnKafka.event.userCreatedEvent.Builder(other);
  }
   ...
   * @return A new userCreatedEvent RecordBuilder
   */
  public static com.ashimCS.learnKafka.event.userCreatedEvent.Builder newBuilder(com.ashimCS.learnKafka.event.userCreatedEvent other) {
    return new com.ashimCS.learnKafka.event.userCreatedEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<userCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ashimCS.learnKafka.event.userCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ashimCS.learnKafka.event.userCreatedEvent other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ashimCS.learnKafka.event.userCreatedEvent.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ashimCS.learnKafka.event.userCreatedEvent.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ashimCS.learnKafka.event.userCreatedEvent.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ashimCS.learnKafka.event.userCreatedEvent.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ashimCS.learnKafka.event.userCreatedEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ashimCS.learnKafka.event.userCreatedEvent.Builder clearEmail() {
      email = null;
